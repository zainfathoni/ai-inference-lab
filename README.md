...
- [Lesson 3 — A tensor is a pointer plus arithmetic](lessons/0003-strides-and-layout.html)
- [Lesson 4 — The GPU fetches more than you asked for](lessons/0004-memory-coalescing.html)
- [Lesson 5 — Quantization: buying bandwidth with precision](lessons/0005-quantization-and-nf4.html)
- [Lesson 6 — Matmul earns its intensity by tiling](lessons/0006-matmul-and-tiling.html)
- [Lesson 7 — Softmax, overflow, and the online trick](lessons/0007-softmax-and-stability.html)
- [Lesson 8 — Attention and the KV cache](lessons/0008-attention-and-kv-cache.html)
- [Lesson 9 — Benchmarking a kernel honestly](lessons/0009-benchmarking-honestly.html)
- [Curriculum — the whole arc and why this order](CURRICULUM/) ([raw](CURRICULUM.md))
